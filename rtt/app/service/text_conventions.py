...
EBK_CONVENTIONS = {
    ...
    ("vectors", "generators"): _VEC,
    ("vectors", "canonical_generators"): _VEC,
    ("vectors", "generator_embedding"): _EMBED,
    ("vectors", "held"): _VEC,
    ...
    ("mapping", "generator_embedding"): _GENMAPPED,
    ("mapping", "generators"): _GENMAPPED,
    ("mapping", "canonical_generators"): _CANON_GEN_STACK,
    ("canonical", "primes"): _CANON_STACK,
    ("canonical", "generators"): _CANON_GEN_STACK,
    ("canonical", "generator_embedding"): _CANON_GEN_STACK,
    ("canonical", "canonical_generators"): _CANON_GEN_STACK,
    ("canonical", "commas"): _MAPPED,
    ("canonical", "targets"): _MAPPED,
    ("canonical", "held"): _MAPPED,
    ("canonical", "interest"): _MAPPED_BARE,
    ...
    ("projection", "generators"): _EMBED,
    ("projection", "primes"): _STACK_ANGLE,
    ("projection", "generator_embedding"): _EMBED,
    ("projection", "canonical_generators"): _EMBED,
    ("projection", "superspace_generators"): _EMBED,
    ("projection", "superspace_primes"): _STACK_ANGLE,
    ("tuning", "generators"): _GENMAP,
    ("tuning", "generator_embedding"): _GENMAP,
    ("tuning", "canonical_generators"): _GENMAP,
    ("tuning", "primes"): _MAP,
    ...
    ("just", "generators"): _SCALARS,
    ("just", "generator_embedding"): _SCALARS,
    ("just", "canonical_generators"): _SCALARS,
    ...
    ("retune", "generators"): _SCALARS,
    ("retune", "generator_embedding"): _SCALARS,
    ("retune", "canonical_generators"): _SCALARS,
    ...
    ("complexity", "generators"): _SCALARS,
    ("complexity", "generator_embedding"): _SCALARS,
    ("complexity", "canonical_generators"): _SCALARS,
    ...
    ("prescaling", "generators"): _VEC,
    ("prescaling", "generator_embedding"): _VEC,
    ("prescaling", "canonical_generators"): _VEC,
    ...
    ("superspace_vectors", "generators"): _VEC,
    ...
    ("superspace_mapping", "generators"): _GENMAPPED,
    ...
    ("superspace_projection", "generators"): _EMBED,
    ...
    ("superspace_vectors", "canonical_generators"): _VEC,
    ("superspace_mapping", "canonical_generators"): _GENMAPPED,
    ("superspace_projection", "canonical_generators"): _EMBED,
    ("just", "superspace_generators"): _SCALARS,
    ("retune", "superspace_generators"): _SCALARS,
    ("complexity", "superspace_generators"): _SCALARS,
    ("prescaling", "superspace_generators"): _VEC,
}
