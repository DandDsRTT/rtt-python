...
EBK_CONVENTIONS = {
    ...
    ("vectors", "interest"): _VEC_BARE, ("vectors", "primes"): _STACK_ANGLE,
    ("mapping", "primes"): _STACK_BRACE_SP, ("mapping", "commas"): _MAPPED,
    ("mapping", "targets"): _MAPPED, ("mapping", "held"): _MAPPED,
    ("mapping", "interest"): _MAPPED_BARE, ("mapping", "gens"): _GENMAPPED,
    ("mapping", "detempering"): _GENMAPPED, ("mapping", "canongens"): _CANON_GEN_STACK,
    ...
    ("projection", "detempering"): _EMBED, ("projection", "primes"): _STACK_ANGLE,
    ("projection", "gens"): _EMBED, ("projection", "canongens"): _EMBED,
    ("projection", "ssgens"): _EMBED, ("projection", "ssprimes"): _STACK_ANGLE,
    ...
    ("ss_vectors", "primes"): _BASIS, ("ss_vectors", "ssprimes"): _STACK_ANGLE,
    ...
    ("ss_mapping", "ssprimes"): _STACK_BRACE, ("ss_mapping", "primes"): _STACK_BRACE,
    ("ss_mapping", "ssgens"): _GENMAPPED, ("ss_mapping", "commas"): _MAPPED,
    ("ss_mapping", "targets"): _MAPPED, ("ss_mapping", "detempering"): _GENMAPPED,
    ("ss_mapping", "held"): _MAPPED, ("ss_mapping", "interest"): _MAPPED_BARE,
    ("ss_projection", "ssprimes"): _STACK_ANGLE, ("ss_projection", "ssgens"): _EMBED,
    ("ss_projection", "primes"): _BASIS, ("ss_projection", "detempering"): _EMBED,
...
def plain_text_values(
    ...
    targets = derived.targets if derived else \
        displayed_targets(state, scheme, target_spec, target_override)
