...
_KIND_HELP: dict[str, str] = {
    ...
    "projcell": "Projection-matrix entry — a fraction of the rational projection 𝑃 = 𝐺𝑀. Retype 𝑃 to retune to the projection it defines (rejected unless it's a valid projection).",
    "embedcell": "Generator-embedding entry — a fraction of 𝐺 (a generator as a fractional vector). Retype 𝐺 to retune to the embedding it defines (rejected unless 𝑀𝐺 = 𝐼).",
