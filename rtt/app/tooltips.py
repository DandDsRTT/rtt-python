...
_APP_FEATURE_HELP = {
    ...
    "form": "Expand the form settings — the form tiles and their colorization, plus the form choosers. A grouping toggle; it shows nothing of its own.",
    ...
    "form_tiles": "Show the canonical (default) form — off canonical, as its own row plus the form matrix 𝐹; on canonical, as a subscript C on the mapping 𝑀, generator tuning map 𝒈, and generator embedding G.",
