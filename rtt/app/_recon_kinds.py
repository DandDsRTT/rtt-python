...
def register_display_kinds(cell_kinds) -> None:
    ...
    cell_kinds["name"] = _KindHandlers(display.build_text_cell, display.update_text_cell)
    cell_kinds["label"] = _KindHandlers(display.build_text_cell, display.update_text_cell)
...
def register_label_kinds(cell_kinds) -> None:
    ...
    cell_kinds["panel_title"] = _KindHandlers(value_kinds.label_builder("rtt-panel-title"), None)
...
def register_button_kinds(cell_kinds) -> None:
    ...
    cell_kinds["plus"] = _KindHandlers(buttons.build_plus, buttons.update_plus)
    cell_kinds["generator_minus"] = _KindHandlers(buttons.build_generator_minus)
    cell_kinds["generator_plus"] = _KindHandlers(buttons.build_generator_plus, buttons.update_plus)
    cell_kinds["map_minus"] = _KindHandlers(buttons.build_map_minus)
    cell_kinds["map_plus"] = _KindHandlers(buttons.build_map_plus, buttons.update_plus)
    ...
    cell_kinds["comma_plus"] = _KindHandlers(buttons.build_comma_plus, buttons.update_plus)
    cell_kinds["detempering_cycle"] = _KindHandlers(buttons.build_detempering_cycle)
    cell_kinds["element_plus"] = _KindHandlers(buttons.build_element_plus, buttons.update_plus)
    ...
    cell_kinds["interest_plus"] = _KindHandlers(buttons.build_interest_plus, buttons.update_plus)
    ...
    cell_kinds["held_plus"] = _KindHandlers(buttons.build_held_plus, buttons.update_plus)
    cell_kinds["target_minus"] = _KindHandlers(buttons.build_target_minus)
    cell_kinds["target_plus"] = _KindHandlers(buttons.build_target_plus, buttons.update_plus)
    ...
    cell_kinds["rowgap"] = _KindHandlers(buttons.build_rowgap)
