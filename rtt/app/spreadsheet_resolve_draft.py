...
class ResolveDraft:
    ...
    ss_projection_basis: object = None
    ss_projection_detempering: object = None
    ss_projection_held: object = None
    ss_projection_targets: object = None
    ss_projection_interest: object = None
