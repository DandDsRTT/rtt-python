...
class TestPerCellAudio:
    ...
    def test_one_pass_voices_every_interval_cell_so_none_are_silently_missed(self):
        ...
        not_a_pitch = (
            ...
            "cell:selfmap", "cell:mapped_detempering", "cell:fcancel", "cell:canonical_embedding",
        )
        silent = [
            c.id
            for c in cells
    ...
    def test_form_layer_subscripts_the_canonical_form_objects_in_symbols(self):
        ...
        assert projection["symbol:vectors:generator_embedding"].text == f"G{C}"
    ...
    def test_form_layer_subscripts_the_canonical_form_objects_in_equivalences(self):
        ...
        assert on["symbol:vectors:generator_embedding"].text == f"G{C} = U(𝑀{C}U)⁻¹"
    ...
    def test_form_layer_subscripts_the_matrix_header_labels(self):
        ...
        assert projection["matrix_label:column:vectors:generator_embedding:0"].text == f"𝐠{C}{s1}"
