...
class TestGuidedTour:
    ...
    def test_a_brand_new_browser_opens_at_the_minimum_chapter(self):
        ...
        assert app._initial_chapter({}) == show_settings.CHAPTER_MIN, "first-run for a genuinely-new # browser opens at the simplest chapter-2 start, matching Reset — not chapter 4"
