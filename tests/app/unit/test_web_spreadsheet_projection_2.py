...
from _spreadsheet_support import (
    _assert_plain_text_cells_match,
    _barbados_state,
...
class TestProjectionDrafts:
    ...
    def test_scaling_factors_grows_a_green_draft_column_for_a_pending_comma(self):
        ...
        c = {cell.id: cell for cell in spreadsheet.build(base, s, held_basis_ratios=("2/1", "5/4"), pending_comma=[None, None, None]).cells}
    ...
    def test_v_column_labels_track_their_cells_during_a_pending_comma(self):
        ...
        rest = {cell.id: cell for cell in spreadsheet.build(base, s, held_basis_ratios=("2/1", "5/4")).cells}
