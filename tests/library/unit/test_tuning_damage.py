...
class TestTuningDamage:
    ...
    def test_generator_tuning_map_damages(self):
        meantone = parse_temperament_data(MEANTONE)
        _assert_damages(
    ...
    def test_tuning_map_damages(self):
        meantone = parse_temperament_data(MEANTONE)
        _assert_damages(
