...
class TestTargetIntervals:
    ...
    def test_filter_target_intervals_for_nonstandard_domain_basis(self, quotients, domain_basis, expected):
        filtered = filter_target_intervals_for_nonstandard_domain_basis(quotients, domain_basis)
