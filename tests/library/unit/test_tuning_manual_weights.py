...
class TestTuningManualWeights:
    def test_matching_override_returned_verbatim(self):
    ...
    def test_mismatched_length_override_falls_back_to_slope(self):
    ...
    def test_non_positive_or_nonfinite_override_falls_back(self, bad):
    ...
    def test_override_reaches_the_solve(self):
    ...
    def test_override_matches_a_handmade_unity_scheme(self):
    ...
    def test_all_interval_ignores_override(self):
